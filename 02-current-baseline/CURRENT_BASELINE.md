...
- `test-change` por `tests/test_engineering_analyze.py`
- `test-change` por `tests/test_engineering_inspect.py`
- `test-change` por `tests/test_knowledge_reader.py`
- `test-change` por `tests/test_repository_reader.py`
