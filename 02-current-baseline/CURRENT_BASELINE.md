...
- `architecture-change` por `docs/architecture/adr/ADR-006-protected-durable-reliance-preconditions.md`
- `architecture-change` por `docs/architecture/adr/ADR-TEMPLATE.md`
