...
- `architecture-change` por `src/malak/capabilities/echo.py`
- `architecture-change` por `src/malak/contracts/capability.py`
...
- `test-change` por `tests/test_capability_registry.py`
- `test-change` por `tests/test_cli.py`
- `test-change` por `tests/test_conversation_capability.py`
- `test-change` por `tests/test_conversation_context.py`
- `test-change` por `tests/test_conversation_service.py`
